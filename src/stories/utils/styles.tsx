...
`;
  ...
  box-sizing: border-box;
  ${(props) =>
      `font-size: ${props.theme.global.input.font.size
  ...
  export const kindPartStyles = (obj, theme, colorValue) => {
    ...
    if (obj.padding || obj.pad) {
      ...
      if (pad.vertical || pad.horizontal)
        styles.push(
          `padding: ${theme.global.edgeSize[pad.vertical] || pad.vertical || 0} ${theme.global.edgeSize[pad.horizontal] || pad.horizontal || 0
          };`,
        );
