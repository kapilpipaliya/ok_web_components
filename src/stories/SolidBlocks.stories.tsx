export default { title: "Application/SolidBlocks" };
  ...
  return (
    <>
      <Accordion>
        ...
        <p class={accordionPara}>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum natus, incidunt, voluptatum ea delectus enim ut ullam, voluptate libero consectetur et esse pariatur fuga.
          Cumque exercitationem inventore voluptates assumenda quae?
        </p>
      </Accordion>
      <Accordion>
        <HeaderAccordion>Accordion Second</HeaderAccordion>
        <p class={accordionPara}>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit perferendis nihil accusantium, magni aspernatur laudantium iusto aut, dignissimos pariatur voluptatem
          exercitationem deleniti. Alias beatae aliquam ad laudantium ratione quod vitae.
        </p>
      </Accordion>
    </>
  );
...
export const Bars = () => {
  return (
    <Bar class={BarStyle} placement="top" portal={false}>
      <Avatar
        class={css`
...
export const Breadcrumbss = () => {
  return (
    <Breadcrumbs variant="primary" placement="top" position="relative" portal="true">
      <a href="/">Home</a>
      <a href="/docs">Docs</a>
      ...
      {({ open, toggle }) => (
        <>
          ...
          <ModalContent>
            ...
            <ModalBody>
              <p>Body of the Modal. You can fill it with whatever content.</p>
            </ModalBody>
            <ModalFooter>
...
export const GroundTag = () => {
  return (
    <TagGroup>
      ...
      <Tag href="https://solidjs.com" target="_blank">
        SolidJS
      </Tag>
      <Tag href="https://typescriptlang.org" target="_blank">
        TypeScript
      </Tag>
    </TagGroup>
  );
...
const types = ["text", "color", "date", "datetime-local", "email", "file", "month", "number", "password", "range", "search", "submit", "tel", "time", "url", "week"];
export const Text_Field = () => {
  return (
    <>
      {types.map((e) => (
        <>
          <TextField aria-orientation="vertical" type={e}>
            {e}
          </TextField>
        </>
      ))}
...
export const Tooltip_Field = () => {
  return (
    <Tooltip trigger="hover" content="i am Tooltip">
      Hello TEst
    </Tooltip>
  );
};
export const Toasts = () => {
  return (
    <Toast position="bottom-left" timeout={0}>
      {({ hide }) => (
        <Message type="info">
          <Button style={{ float: "right" }} variant="icon" onclick={hide}>
            ✕
          </Button>
          {"Toast content"}
        </Message>
